...
public class TestTypeVO {
   ...
   public String toString() {
      return "TestTypeVO [burger=" + burger + ", jorengi=" + jorengi + ", coding=" + coding + ", teacher=" + teacher
            + ", userPk=" + userPk + ", userName=" + userName + ", testTypePk=" + testTypePk + ", testTypeResult="
            + testTypeResult + ", testTypeDetails=" + testTypeDetails + ", sessionUserPk=" + sessionUserPk + "]";
   }
